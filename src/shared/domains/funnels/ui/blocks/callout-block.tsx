  ...
  return (
    <Block media="right" surface="card" align="left">
      <Block.Content>
          ...
          ? (
              <ul className="flex flex-col gap-2">
                {content.points.map(point => (
                  <li key={point} className="flex items-center gap-2 text-[length:var(--fs-body)]" style={POINT_TEXT_STYLE}>
        ...
        <Block.Actions>
          <button type="button" className="bg-foreground text-card inline-flex items-center gap-2.5 rounded-[3px] px-6 py-3.5 text-[length:var(--fs-body)] font-bold">
