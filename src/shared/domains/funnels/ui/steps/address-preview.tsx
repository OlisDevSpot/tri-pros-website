 ...
 *
 * `showAddressLabel` controls the labeled address line under the aerial. It
 * defaults to `true`, but a surface that already echoes the picked address
 * (e.g. the funnel's autocomplete input) passes `false` to avoid showing the
 * same address twice.
 */
export function AddressPreview({ fullAddress, showAddressLabel = true }: { fullAddress: string, showAddressLabel?: boolean }) {
