...
export const blockVariants = cva(
  'relative w-full isolate overflow-hidden',
  {
    variants: {
      media: {
        none: '',
        right: 'flex flex-col gap-[var(--block-gap)] rounded-md md:block md:min-h-[var(--block-media-min-h)] [&>[data-slot=block-content]]:relative [&>[data-slot=block-content]]:z-10 [&>[data-slot=block-content]]:p-[var(--block-pad)] md:[&>[data-slot=block-content]]:my-[var(--block-pad)] md:[&>[data-slot=block-content]]:w-[52%] md:[&>[data-slot=block-content]]:rounded-md md:[&>[data-slot=block-content]]:bg-card md:[&>[data-slot=block-content]]:shadow-[0_18px_48px_-14px_rgb(0_0_0/0.45)]',
        left: 'flex flex-col gap-[var(--block-gap)] rounded-md md:block md:min-h-[var(--block-media-min-h)] [&>[data-slot=block-content]]:relative [&>[data-slot=block-content]]:z-10 [&>[data-slot=block-content]]:p-[var(--block-pad)] md:[&>[data-slot=block-content]]:my-[var(--block-pad)] md:[&>[data-slot=block-content]]:ml-auto md:[&>[data-slot=block-content]]:w-[52%] md:[&>[data-slot=block-content]]:rounded-md md:[&>[data-slot=block-content]]:bg-card md:[&>[data-slot=block-content]]:shadow-[0_18px_48px_-14px_rgb(0_0_0/0.45)]',
      },
      surface: {
        plain: 'bg-background',
