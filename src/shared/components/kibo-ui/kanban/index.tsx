...
export function KanbanCard<T extends KanbanItemProps = KanbanItemProps>({
  ...
  const { activeCardId } = use(KanbanContext) as KanbanContextProps
...
export function KanbanCards<T extends KanbanItemProps = KanbanItemProps>({
  ...
  const { data } = use(KanbanContext) as KanbanContextProps<T>
...
export function KanbanHeader({ className, ...props }: KanbanHeaderProps) {
  return <div className={cn('m-0 p-2 font-semibold text-sm', className)} {...props} />
}
...
>({
  ...
  return (
    <KanbanContext value={{ columns, data, activeCardId }}>
      <DndContext
