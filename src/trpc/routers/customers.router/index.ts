...
export const customersRouter = createEntityRouter(customerServerSpec, (entity) => {
  return createTRPCRouter({
    ...
    // Generated by createCrudRouter. spec.update.jsonbMergeColumns registers sole
    // remaining merge for leadMetaJSON (top-level-only ||, Wave 2 removes); spec.hooks.delete.before cascades meeting
