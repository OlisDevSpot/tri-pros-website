...
import type { ProjectRow } from '@/features/project-management/ui/components/table/columns'
...
import { useProjectActions } from '@/features/project-management/hooks/use-project-actions'
...
export function PortfolioProjectsView() {
  ...
  const projects = useQuery(trpc.projectsRouter.crud.getAll.queryOptions())
