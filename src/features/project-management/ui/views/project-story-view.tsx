...
import { StoryChallenge } from '@/features/project-management/ui/components/story-challenge'
import { StoryGallery } from '@/features/project-management/ui/components/story-gallery'
import { StoryHero } from '@/features/project-management/ui/components/story-hero'
import { StorySolution } from '@/features/project-management/ui/components/story-solution'
import { StoryTestimonial } from '@/features/project-management/ui/components/story-testimonial'
import { StoryTimeline } from '@/features/project-management/ui/components/story-timeline'
...
export function ProjectStoryView({ detail }: Props) {
  const trpc = useTRPC()
