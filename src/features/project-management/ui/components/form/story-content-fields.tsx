...
import { STORY_LABELS } from '@/shared/modules/projects/core/constants/project-story'
      ...
      <div className="flex flex-col gap-6 border border-border/30 shadow p-6 rounded-xl bg-[color-mix(in_oklch,var(--card)_97%,var(--foreground)_3%)]">
        <div className="flex flex-col gap-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{STORY_LABELS.challenge}</FormLabel>
                <FormControl>
                  <Textarea
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{STORY_LABELS.solution}</FormLabel>
                <FormControl>
                  <Textarea
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{STORY_LABELS.result}</FormLabel>
                <FormControl>
                  <Textarea
