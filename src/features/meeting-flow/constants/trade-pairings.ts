...
export const TRADE_PAIRINGS: Record<string, TradePairing> = {
  'roof-and-gutters': { pairedSlug: 'attic-and-basement', reason: 'the attic is already accessible' },
  ...
  'windows-and-doors': { pairedSlug: 'attic-and-basement', reason: 'envelope sealing, the complete comfort story' },
}
