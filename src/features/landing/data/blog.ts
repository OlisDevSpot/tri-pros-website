export const blogPostTitles = [
  "10 Energy-Efficient Home Upgrades That Will Cut Your Utility Bill in Half",
  ...
  "From Drafty to Efficient: One Family’s Green Renovation Story",
  "Think You Know Energy-Efficient Windows? These 7 Facts Will Surprise You",
];
