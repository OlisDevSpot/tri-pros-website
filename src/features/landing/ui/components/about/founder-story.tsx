export function FounderStory() {
  return (
    <div>
      <p>
        My name is Sean, and long before Tri Pros Remodeling existed, I learned what responsibility really means. I served in the Israeli Special Forces, where the stakes were measured in lives, not deadlines. Later, I had the privilege of training U.S. Marines and working alongside American veterans—men and women who know hardship in a way that can’t be taught in a classroom. Seeing their challenges up close, both during service and after returning home, gave me a lasting respect for grit, honesty, and having someone you can rely on.
