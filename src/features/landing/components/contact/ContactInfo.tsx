...
export default function ContactInfo() {
  return (
    <section className="bg-gradient-to-br from-primary to-primary/90 py-16 lg:py-24 text-primary-foreground">
        ...
        >
          ...
          <div className="space-y-6">
            ...
            {offices.map((office, index) => (
              ...
              >
                <h4 className="font-serif text-lg font-bold text-secondary mb-3">
                  {office.name}
                </h4>
