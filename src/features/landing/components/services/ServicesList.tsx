    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              {index < services.length - 1 && (
                <motion.div
                  ...
                  className="h-px bg-gradient-to-r from-transparent via-border to-transparent mt-16"
                />
              )}
            </motion.div>
          ))}
        ...
        <motion.div
          ...
          className="mt-20 bg-gradient-to-br from-primary to-primary/90 rounded-2xl p-8 lg:p-12 text-center text-primary-foreground"
        >
