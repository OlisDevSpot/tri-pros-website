import type { AddonAccessor, TradeAccessor } from '@/db/types'
...
export const painPoints = {
  ...
  healthAndComfort: [
    ...
    },
    {
      ...
      trades: ['hvac', 'hazardousMaterials', 'plumbing', 'roof', 'windows'],
      addons: ['atticAirSealing'],
      tags: ['health', 'iaq'],
    },
  ],
  financialConsiderations: [
    {
      ...
      trades: ['windows', 'dryscapingHardscaping', 'roof', 'exteriorPaintSiding', 'exteriorFeatures', 'adu'],
    ...
    },
    {
      ...
      trades: ['hvac', 'atticBasement', 'electricals', 'windows'],
      addons: ['atticAirSealing'],
      tags: ['energy', 'cost'],
    },
    {
