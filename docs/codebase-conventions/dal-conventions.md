...
Only files under `src/shared/dal/`, `src/shared/entities/*/dal/`, or `src/shared/modules/*/*/dal/` import the `db` client from `@/shared/db`. tRPC procedures, services, and jobs always go through DAL.
...
**Reference impl**: any file in `src/shared/modules/proposals/core/dal/server/`
...
**Reference impl**: `src/shared/dal/server/types.ts` (definitions); `src/shared/modules/proposals/core/dal/server/queries.ts` (usage)
...
**Reference impl**: `src/shared/modules/proposals/core/dal/server/queries.ts`
...
Both live under `src/shared/entities/<entity>/dal/server/` or `src/shared/modules/<module>/<unit>/dal/server/` (or `src/shared/dal/server/<domain>/` for cross-entity DAL).
...
**Reference impl**: `src/shared/modules/proposals/core/dal/server/queries.ts` (mix of CRUD via spec + business reads)
...
DAL directories (`dal/server/`, `dal/client/`) do not have `index.ts` barrel files. Imports use the full path: `import { listProposals } from '@/shared/modules/proposals/core/dal/server/queries'`.

**Why**: barrels create implicit re-exports that obscure where code lives. Full paths are greppable.
**Reference impl**: `src/shared/modules/proposals/core/dal/server/` (no index.ts)
**Enforced by**: convention
