...
| [pdf-documents.md](./pdf-documents.md) | Doc-definition builders, `renderPdf` chokepoint, WinAnsi text hygiene, homeowner-safe data, layout geometry, Vercel tracing, verification workflow |
